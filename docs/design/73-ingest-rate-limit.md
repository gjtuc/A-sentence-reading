...
1. Live Cloud Run `/api/status`: `version=0.2.98`, `ingest_rate_limit=true` (browser + Invoke-RestMethod)
2. Sideload APK `versionName=0.2.98` · Google 로그인 · Settings→서버: `version | 0.2.98`
