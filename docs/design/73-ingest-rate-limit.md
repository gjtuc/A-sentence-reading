...
Web/mobile **0.2.91** · pubspec `0.2.91+1`

## Device / live E2E (2026-08-10)

1. Live Cloud Run `/api/status`: `version=0.2.91`, `ingest_rate_limit=true` (browser + Invoke-RestMethod)
2. Sideload APK `versionName=0.2.91` · Google 로그인 · Settings→서버: `version | 0.2.91`
