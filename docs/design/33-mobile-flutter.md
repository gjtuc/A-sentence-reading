...
- [x] 이메일 로그인·세션 쿠키 (0.2.72 · [61](61-mobile-email-auth.md)) — 수단 1/3
...
- [x] 현재 문장 TTS 재생 (0.2.72 · [64](64-mobile-tts.md))
- [ ] 테마 3종 전환 유지(재실행 후)
...
3. ~~이메일 인증~~ → ~~보관~~ → ~~읽기~~ → ~~TTS~~ (0.2.69–0.2.72) · Google/카카오
...
웹 **0.2.72** · `mobile_tts` · pubspec `0.2.72+1`
