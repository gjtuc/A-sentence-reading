...
- [x] 이메일 로그인·세션 쿠키 (0.2.80 · [61](61-mobile-email-auth.md)) — 수단 1/3
- [x] Google·카카오 앱 로그인 배선 (0.2.80 · [65](65-mobile-oauth.md)) — 수단 3/3
- [x] 액세스 게이트 OTP·Allow/Deny (0.2.80 · [67](67-access-gate.md))
...
- [x] 현재 문장 TTS 재생 (0.2.80 · [64](64-mobile-tts.md))
- [x] 테마 3종 전환 유지(재실행 후) (0.2.80 · [66](66-mobile-theme.md))
...
3. ~~이메일·보관·읽기·TTS·Google/카카오~~ (0.2.69–0.2.80)
4. ~~테마 3종~~ (0.2.80) · release APK · 실기 사이드로드 (Android SDK)
...
웹 **0.2.80** · `access_gate` · pubspec `0.2.80+1`
