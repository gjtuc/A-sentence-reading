...
Client `TimeoutException` on GET(45s) / build(150s) **continues** pending slices
(design/113 intent). Soft busy banner may show `progress_done/total`. Hard red
error only for `status=error` / API fail / unknown shape / slice cap exhaustion.
