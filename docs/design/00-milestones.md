...
- ~~업로드·ingest 호출 횟수 한도~~ (0.2.98 — [73-ingest-rate-limit.md](73-ingest-rate-limit.md); 횟수만 · daily/용량 한도 없음)
- ~~백그라운드 업로드 알림 · FG · 완료 탭 열기~~ (0.2.98 — [74-bg-upload-notify.md](74-bg-upload-notify.md); ASR_MOBILE_UPLOAD_BACKGROUND)
- ~~전화·OEM 중단 후 업로드 자동 재개~~ (0.2.98 — [75-upload-interrupt-resume.md](75-upload-interrupt-resume.md); approach A · ASR_MOBILE_UPLOAD_INTERRUPT_RESUME)
- ~~프로세스 종료 후 WorkManager 이어올리기~~ (0.2.98 · [76-upload-workmanager.md](76-upload-workmanager.md); ASR_MOBILE_UPLOAD_WORKMANAGER)
- ~~이메일 매직링크 로그인 · 앱 딥링크~~ (0.2.98 · [77-email-magic-link.md](77-email-magic-link.md); ASR_EMAIL_MAGIC_LINK · OTP 게이트 유지)
- ~~이메일 비밀번호 가입/로그인 제거 · OAuth+매직링크~~ (0.2.98 · [78-no-email-password-signup.md](78-no-email-password-signup.md))
- ~~쉐도잉 연습 옵트인(킬·설정 토글)~~ (0.2.98 · [79-shadowing-opt-in.md](79-shadowing-opt-in.md); ASR_SHADOWING_PRACTICE)
- ~~쉐도잉 청크 계획(유저별·ingest/백필)~~ (0.2.98 · [80-shadowing-chunks.md](80-shadowing-chunks.md); ASR_SHADOWING_PRACTICE)
- ~~헤더 ⋯ 메뉴 overflow · Cloud Run 쉐도잉 킬 변수~~ (0.2.98 · [81-header-more-overflow.md](81-header-more-overflow.md))
