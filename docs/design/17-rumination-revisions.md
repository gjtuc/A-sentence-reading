...
- 뒤로 가기(`-1`)에서는 리뷰 안 띄움
- 리뷰 행: ~~글 영역 클릭 → 문장 선택~~ → **0.2.59** 부터 구간 노트를 **한 박스에 이어 보기** ([51](51-section-review-flow.md)); **0.2.60** **▶ 이어 듣기** ([52](52-section-review-voice-seq.md)); 헤더「되새김」on/off ([53](53-section-review-optional.md) · 0.2.61); 일시 정지 클립 재듣기/재녹음 ([54](54-section-review-voice-clip.md) · 0.2.62); flow 콕 수정 ([55](55-section-review-flow-edit.md) · 0.2.63); 키보드 패리티 ([56](56-section-review-keys.md) · 0.2.64); 흰 십자 ([57](57-section-review-crosshair.md) · 0.2.65); 헤더 `⋯` ([58](58-header-overflow.md) · 0.2.66); Guide 밖/`⋯` 안 ([59](59-guide-header.md) · 0.2.67 ·「되새김」은 메뉴 안 · 인덱스 불변)
