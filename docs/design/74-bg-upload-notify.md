...
1. APK `versionName=0.2.99` · `POST_NOTIFICATIONS` granted
...
- Cloud Run `/api/status`: `version=0.2.99`, `mobile_upload_background=true`
- Device APK `versionName=0.2.99` (sideload) · SM-G986N
