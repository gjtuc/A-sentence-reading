...
1. APK `versionName=0.2.92` · `POST_NOTIFICATIONS` granted
...
- Cloud Run `/api/status`: `version=0.2.92`, `mobile_upload_background=true`
- Device APK `versionName=0.2.92` (sideload) · SM-G986N
