...
Web/mobile **0.3.2** · pubspec `0.3.2+1`

## Device E2E (SM-G986N · sideload)

1. APK `versionName=0.3.2` · `POST_NOTIFICATIONS` granted
...
- Cloud Run `/api/status`: `version=0.3.2`, `mobile_upload_background=true`
- Device APK `versionName=0.3.2` (sideload) · SM-G986N
