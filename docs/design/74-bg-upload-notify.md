...
1. APK `versionName=0.3.0` · `POST_NOTIFICATIONS` granted
...
- Cloud Run `/api/status`: `version=0.3.0`, `mobile_upload_background=true`
- Device APK `versionName=0.3.0` (sideload) · SM-G986N
