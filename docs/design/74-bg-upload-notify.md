...
Web/mobile **0.2.97** · pubspec `0.2.97+1`

## Device E2E (SM-G986N · sideload)

1. APK `versionName=0.2.97` · `POST_NOTIFICATIONS` granted
...
- Cloud Run `/api/status`: `version=0.2.97`, `mobile_upload_background=true`
- Device APK `versionName=0.2.97` (sideload) · SM-G986N
