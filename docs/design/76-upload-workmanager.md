...
**0.2.95** · pubspec `0.2.95+1`

## Device E2E (pre-merge)

- APK `versionName=0.2.95` · SM-G986N
...
- Cloud Run `/api/status`: `version=0.2.95`, `mobile_upload_workmanager=true`
- Device APK `versionName=0.2.95` · SM-G986N
