...
| 183 | [183-reader-layout-by-first-fig-chip.md](183-reader-layout-by-first-fig-chip.md) | 첫 Fig/Table 칩 기준 리더 레이아웃 (**0.3.174**) |
...
183 — 첫 Fig/Table 칩 기준 리더 레이아웃 auto · Intro collapse · cite 접기 (0.3.174).
