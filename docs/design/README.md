...
| 185 | [185-local-paper-sot.md](185-local-paper-sot.md) | 분석 논문 로컬 SoT · handoff + abandon/bulk/polish (**0.3.181**) |
| 186 | [186-device-transfer-pack.md](186-device-transfer-pack.md) | 7일 기기 이전 팩 · papers와 분리 (**0.3.180**) |
...
| 339 | [339-speech-defects-from-the-linter.md](339-speech-defects-from-the-linter.md) | 린터가 찾은 발화 결함 수정 — 아래첨자 단어·이탤릭 변수·보충 라벨·부등호·단위 (224→83, 0.3.334 · speak_norm v8) |
| 340 | [340-back-matter-is-not-practice.md](340-back-matter-is-not-practice.md) | 저널 부속물은 논문이 아니다 — 라이선스·DOI·마스트헤드를 문장 스트림에서 제외·계수 (0.3.335) |
| 341 | [341-unit-grammar-and-the-ratio-slash.md](341-unit-grammar-and-the-ratio-slash.md) | 단위 런은 문법이다 — 지워지던 양의 지수 복구·`·`는 구분자·기호 사이 슬래시는 비율 (224→45, 0.3.336 · speak_norm v9) |
...
| 250 | [250-practice-cloud-sync.md](250-practice-cloud-sync.md) | Practice focus+skill cloud sync (0.3.241) |
| 249 | [249-mobile-folder-docx.md](249-mobile-folder-docx.md) | Folder/downloads docx list + upload (0.3.240) |
| 248 | [248-pdf-import-downloads-inapp-browser.md](248-pdf-import-downloads-inapp-browser.md) | Downloads in-app list (reuse import UI) (0.3.239) |
