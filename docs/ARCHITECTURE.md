...
| 클라이언트 | Android | `mobile/` + `android/` + 이메일·보관 (0.2.55–0.2.56 · 0.2.69–0.2.73 · design/33·47·48·61·62) · Live Enable/IPS 없음 |
...
| UI | 헤더 | 「파일 열기」+ `⋯` (0.2.66 · design/58) · Guide 밖/`⋯` 안 (0.2.67 · design/59) · 패널 hint 기본 숨김 (0.2.73 · design/60) · Live Enable/IPS 없음 (Trading Gate) |
...
다음: Google/카카오 · 실기 APK (TTS 0.2.73 완료).
