/// design/213 — durable local queue for practice skill evidence (no text/audio).
library;
...
class SkillEvidenceStore {
  SkillEvidenceStore({this.maxEvents = 5000});
  ...
  Future<File> _ensureFile() async {
    ...
    final dir = Directory(
      '${root.path}${Platform.pathSeparator}practice_skill_evidence'
