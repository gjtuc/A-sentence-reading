/// Pending upload draft for resume (design/71).
library;
...
/// Local + job reattach state. Never stores session cookies or secrets.
class UploadDraft {
  UploadDraft({
  ...
  /// `uploading` = bytes not yet accepted; `processing` = have job_id to poll.
  final String phase;
