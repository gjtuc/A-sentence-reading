"""Flutter mobile/ scaffold contract (0.2.89 · design/33 · design/47)."""
...
def test_mobile_tree_and_pubspec() -> None:
    ...
    assert "0.2.89" in pub or "0.2.56" in pub
    assert "http:" in pub
...
def test_html_asset_bust_tracks_app_version() -> None:
    ...
    assert "app.js?v=0.2.89" in html
    assert "styles.css?v=0.2.89" in html
