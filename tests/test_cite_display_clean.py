...
def test_plain_trailing_acs_cite_parse_and_strip() -> None:
    """ACS plain cite — reaction.6−9 · worldwide.1−5 (0.3.140)."""
    minus = "\u2212"
...
def test_plain_trailing_acs_cite_korean_translation_strip() -> None:
    """KO translation may keep ACS plain cites after Hangul (0.3.140)."""
    minus = "\u2212"
...
def test_ui_hides_cites_like_fig_chips() -> None:
    ...
    assert "app.js?v=0.3.140" in html
    assert "styles.css?v=0.3.140" in html
