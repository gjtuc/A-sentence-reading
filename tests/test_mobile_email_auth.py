"""Flutter mobile email auth contract (0.2.97 · design/33 · design/61)."""
...
def test_mobile_dart_auth_sources() -> None:
    ...
    assert "0.2.97" in design or "0.2.97" in design
...
def test_html_asset_bust_tracks_app_version() -> None:
    ...
    assert "styles.css?v=0.2.97" in html
