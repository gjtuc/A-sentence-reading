"""Flutter mobile email auth contract (0.2.90 · design/33 · design/61)."""
...
def test_html_asset_bust_tracks_app_version() -> None:
    ...
    assert "app.js?v=0.2.90" in html
    assert "styles.css?v=0.2.90" in html
