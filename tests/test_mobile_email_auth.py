"""Flutter mobile email auth contract (0.3.3 · design/33 · design/61)."""
...
def test_mobile_dart_auth_sources() -> None:
    ...
    # design/78 — password signup/login removed from UI; magic-link remains.
    ...
    assert "0.3.3" in design or "0.3.3" in design
...
def test_html_asset_bust_tracks_app_version() -> None:
    ...
    assert "app.js?v=0.3.18" in html
    assert "styles.css?v=0.3.18" in html
