"""Flutter mobile library list/open contract (0.2.71 · design/33 · design/62)."""
...
def test_html_asset_bust_tracks_app_version() -> None:
    ...
    assert "app.js?v=0.2.71" in html
